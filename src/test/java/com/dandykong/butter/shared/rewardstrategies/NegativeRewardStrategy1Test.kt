...
import com.dandykong.butter.shared.state.MIN_WEIGHT
import com.dandykong.butter.shared.state.TestState
...
internal class NegativeRewardStrategy1Test {
    ...
    fun shouldUpdateWeightsForTrainingSession() {
        ...
        NegativeRewardStrategy1<Int, TestState>().updateWeights(selectedWeights)
