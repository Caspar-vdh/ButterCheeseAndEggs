...
import com.dandykong.butter.shared.actionselectionstrategies.MultipleSelectionStrategy
import com.dandykong.butter.shared.actionselectionstrategies.RandomSelectionStrategy
import com.dandykong.butter.shared.actionselectionstrategies.SelectChanceByWeightStrategy
import com.dandykong.butter.shared.actionselectionstrategies.SelectFirstNonZeroStrategy
...
//    val strategy = SelectChanceByWeightStrategy()
        ...
        val players: Array<CPUPlayer<Int, TicTacToeGridState>> = arrayOf(
